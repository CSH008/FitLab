...
public class VideosActivity extends BaseMainActivity implements VideoAdapter.OnListFragmentInteractionListener,
    ...
    public static String CODE_WORKOUT_MOBILITY_VIDEOS = "01";
    public static String CODE_WORKOUT_EXERCISE_VIDEOS = "03";
    public static String CODE_WORKOUT_STRETCHING_VIDEOS = "02";
