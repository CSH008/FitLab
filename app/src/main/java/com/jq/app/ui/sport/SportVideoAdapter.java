 ...
 */
public class SportVideoAdapter extends RecyclerView.Adapter<SportVideoAdapter.ViewHolder> {
    ...
    public SportVideoAdapter(List<BaseModel> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
