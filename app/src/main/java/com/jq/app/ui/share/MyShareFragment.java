...
public class MyShareFragment extends BaseFragment {
    ...
    MyShareVideosFragment myShareVideosFragment = new MyShareVideosFragment();
    MyShareImagesFragment myShareImagesFragment = new MyShareImagesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myShareVideosFragment = new MyShareVideosFragment();
        myShareImagesFragment = new MyShareImagesFragment();
        adapter.addFragment(myShareVideosFragment, "Videos");
        adapter.addFragment(myShareImagesFragment, "Images");
         ...
         * set text
         */
        ((TextView) view.findViewById(R.id.tv_share)).setText("Press hold to share");
