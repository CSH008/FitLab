...
public class BThread extends BThreadEntity  {
    ...
    public Entity.Type getEntityType() {
        return com.jq.chatsdk.dao.entity_interface.Entity.Type.bEntityTypeThread;
    }
     ...
     *  If thread has more users then we will take 2/3 first users images that we could find, This will be used to make a combine image for the thread. {@link com.jq.chatsdk.Utils.asynctask.MakeThreadImage MakeThreadImage} */
    ...
    public boolean hasUser(BUser user){
        ...
        com.jq.chatsdk.dao.UserThreadLink data =
                DaoCore.fetchEntityWithProperties(com.jq.chatsdk.dao.UserThreadLink.class,
