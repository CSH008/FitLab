 ...
 * See {@link com.jq.chatsdk.network.BDefines.Exit} for setting the app exit action.
 *
 * Example for it's use is in {@link com.jq.chatsdk.activities.ChatSDKMainActivity#exitHelper MainActivity exit helper}
 */
