...
public class ChatSDKProfileHelper {
    ...
    public void setProfilePic(final Bitmap bitmap){
        ...
        View containerView = mainView.findViewById(R.id.frame_profile_image_container);
        final int size;
        if(containerView!=null) {
            size = containerView.getMeasuredHeight();
        } else {
            size = profileCircleImageView.getMeasuredHeight();
        }
