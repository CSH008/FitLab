...
import com.jq.chatsdk.BuildConfig;
...
public class BDefines {
    ...
    public static String ServerUrl = "https://fitlab-658a4.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://fitlab-658a4.appspot.com";
     ...
     * @see com.jq.chatsdk.Utils.ImageUtils#getInitialsBitmap(int, int, String)
     * */
