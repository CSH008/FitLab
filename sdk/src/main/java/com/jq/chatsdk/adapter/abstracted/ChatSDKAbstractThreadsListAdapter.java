...
package com.jq.chatsdk.adapter.abstracted;
...
//                if (DEBUG) Log.d(TAG, "Thread has more then 2 users.");
     ...
     *
     * If you want to add more data to your list you can extend the absract adapter after that you can extend the {@link com.jq.chatsdk.adapter.abstracted.ChatSDKAbstractThreadsListAdapter.ThreadListItem ThreadListItem}
     * And add new variables to keep it and populate then in with your maker.
     *
     * @see com.jq.chatsdk.adapter.abstracted.ChatSDKAbstractThreadsListAdapter.ThreadListItemMaker#fromBThread(com.jq.chatsdk.dao.BThread)
     * @see com.jq.chatsdk.adapter.abstracted.ChatSDKAbstractThreadsListAdapter.ThreadListItemMaker#getGroupsHeader()
